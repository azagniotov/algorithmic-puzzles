...
class BinarySearch2DArrayTake2 {
    ...
    BinarySearch2DArrayTake2(final int rows, final int cols) {
        this.rows = rows;
        this.cols = cols;
        this.matrix = Utils.seed(rows, cols);
    }
    ...
    public static void main(String[] args) {
        final BinarySearch2DArrayTake2 binarySearch2DArrayTake2 = new BinarySearch2DArrayTake2(7, 7);

        binarySearch2DArrayTake2.dump();

        int[] coordinates = binarySearch2DArrayTake2.coordinates(27);
