...
class Rotate2DArrayTake5 {

    private final int rows;
    private final int cols;
    private final int[][] matrix;

    Rotate2DArrayTake5(final int rows, final int cols) {
        this.rows = rows;
        this.cols = cols;
    ...
    public static void main(String[] args) {
        final Rotate2DArrayTake5 matrixFlipper = new Rotate2DArrayTake5(7, 7);
