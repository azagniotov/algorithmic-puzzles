...
import linguistic_chains.common.preconditions.Preconditions;
import linguistic_chains.utils.StringUtils;
...
public final class Graph {
    ...
    Node constructTree() {
        ...
        for (int idx = wordsByLength.size() - 1; idx >= 0; idx--) {
            final int currentLength = allLengths.get(idx);
            final Set<String> words = this.wordsByLength.get(currentLength);
